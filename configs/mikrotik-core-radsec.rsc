# RadSec (RFC 6614) setup for the DHCP lab core router.
...
/radius add service=dhcp address=10.0.2.2 protocol=radsec certificate=radsec-client secret=radsec timeout=3s
